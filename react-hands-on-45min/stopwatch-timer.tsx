...
function formatMs(ms: number) {
  ...
  if (h > 0) return `${h}:${String(mm).padStart(2, '0')}:${String(ss).padStart(2, '0')}.${frac}`;
...
type CountdownProps = { initialSeconds: number };

export function CountdownTimer({ initialSeconds }: CountdownProps) {
