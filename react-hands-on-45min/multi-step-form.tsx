...
type Step = {
  title: string;
  fields: { name: string; label: string; type: 'text'; required?: boolean }[];
};
...
function validateStep(step: Step, data: Record<string, string>) {
...
export function MultiStepForm() {
  ...
  const [donePayload, setDonePayload] = useState<string | null>(null);
