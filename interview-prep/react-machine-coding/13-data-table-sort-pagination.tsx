...
export type Column<T> = {
  id: string;
  header: string;
  /** Return sortable primitive or string for default compare */
...
export function DataTable<T>({ rows, columns, pageSize = 5, getRowId }: Props<T>) {
  const [sortCol, setSortCol] = useState<string | null>(columns[0]?.id ?? null);
